...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/network.png" alt="Two layer network" style="width:60%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/loss_result.png" alt="Synthetic Data Loss vs Epochs" style="width:65%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/sample_images.png" alt="MNIST dataset sample images" style="width:55%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/loss_batch.png" alt="Loss over batches" style="width:65%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/loss_5_epochs.png" alt="Loss over 5 epochs" style="width:65%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/loss_iterations.png" alt="Loss with weights initialization" style="width:65%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/loss_lr_batch.png" alt="Loss over epoch for multiple learning rates" style="width:65%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/config.png" alt="Model hyperparameters" style="width:35%;">
</div>

We trained the model for 5 epochs and evaluated its performance.

<div style="text-align:center;">
    <img src="../assets/images/assignment_1/model_eval.png" alt="Model evaluation using canonical test dataset" style="width:75%;">
</div>
...
<div style="text-align:center;">
    <img src="../assets/images/assignment_1/confusion_matrix.png" alt="Test dataset confusion matrix. Predictions vs Labels" style="width:75%;">
</div>
